  ...
  return (
    <div className="navbar-dash sticky top-0 shadow-lg m-auto bg-white px-[20px] lg:px-[40px] py-[10px] z-50">
        ...
        <div className="cta flex gap-5 items-center">
          {role === "department" && (
            <div className="relative">
              ...
              >
                <span className="absolute bg-red-400 text-white w-[18px] h-[18px] rounded-full flex items-center justify-center top-[-7px] right-[-2px]">
                  {num}
                </span>
      ...
      <div className="md:hidden z-10">
        ...
        <div
          className={`sidebar absolute top-[60px] transition-all duration-300 ${
            isOpen ? "right-0" : "-right-[300px]"
          }
      p-5 py-5 w-[271px] shadow-2xl z-0`}
