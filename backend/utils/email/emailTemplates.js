...
export const requestRefusalTemplate = (username, requestDetails, refusalReason) => {
    return `
    <!DOCTYPE html>
    <html>
    <head>
        <meta charset="utf-8">
        <title>Print Request Refused</title>
        <style>
            body {
                font-family: 'Cairo', Arial, sans-serif;
                line-height: 1.6;
    ...
    <body>
        <div class="container">
            <div class="header">
                <h1>Print Request Refused</h1>
            </div>
            <div class="content">
                <p class="message">Hello <span class="highlight">${username}</span>,</p>
                <p class="message">Your print request has been refused by the department:</p>
                ...
                <p class="message">You can submit a new request with the necessary corrections.</p>
                <p class="message">Best regards,<br>Print Management Team</p>
            </div>
            <div class="footer">
                <p>This is an automated message, please do not reply to this email.</p>
